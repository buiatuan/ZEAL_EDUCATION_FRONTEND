                ...
                <div className="col-md-9">
                  <div className="udb">
                    ...
                    <div className="udb-sec udb-cour">
                      <h4><img src={require('../asserts/images/icon/db2.png')} alt="" /> Booking Courses</h4>
                      ...
                      <div className="sdb-cours">
                        <ul>
                          <li>
                            <Link to="../#">
                              <div className="list-mig-like-com com-mar-bot-30">
                                <div className="list-mig-lc-img"> <img src={require('../asserts/images/course/3.jpg')} alt="" /> <span className="home-list-pop-rat list-mi-pr">Duration:150 Days</span> </div>
                          ...
                          <li>
                            <Link to="../#">
                              <div className="list-mig-like-com com-mar-bot-30">
                                <div className="list-mig-lc-img"> <img src={require('../asserts/images/course/4.jpg')} alt="" /> <span className="home-list-pop-rat list-mi-pr">Duration:60 Days</span> </div>
                                <div className="list-mig-lc-con">
                          ...
                          <li>
                            <Link to="../#">
                              <div className="list-mig-like-com com-mar-bot-30">
                                <div className="list-mig-lc-img"> <img src={require('../asserts/images/course/5.jpg')} alt="" /> <span className="home-list-pop-rat list-mi-pr">Duration:30 Days</span> </div>
                                <div className="list-mig-lc-con">
                          ...
                          <li>
                            <Link to="../#">
                              <div className="list-mig-like-com com-mar-bot-30">
                                <div className="list-mig-lc-img"> <img src={require('../asserts/images/course/3.jpg')} alt="" /> <span className="home-list-pop-rat list-mi-pr">Duration:20 Days</span> </div>
                                <div className="list-mig-lc-con">
                                  <h5>Master of Science</h5>
                                  <p>Illinois City,</p>
                                </div>
                    ...
                    <div className="udb-sec udb-cour-stat">
                      <h4><img src={require('../asserts/images/icon/db3.png')} alt="" /> Course Status</h4>
                      <p>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text.The point of using Lorem Ipsummaking it look like readable English.</p>
                    ...
                    <div className="udb-sec udb-time">
                      <h4><img src={require('../asserts/images/icon/db4.png')} alt="" /> Class Time Line</h4>
