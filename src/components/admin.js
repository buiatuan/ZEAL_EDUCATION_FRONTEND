          ...
          <div className="sb2-2">
            ...
            <div className="sb2-2-2">
              <ul>
                ...
                <li className="page-back"><Link to="../"><i className="fa fa-backward" aria-hidden="true" /> Back</Link>
                </li>
              </ul>
            </div>
            {/*== DASHBOARD INFO ==*/}
                    ...
                    <div className="tab-inn">
                      <div className="table-responsive table-desi">
                        <table className="table table-hover">
                          ...
                          <tbody>
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/user/1.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/user/2.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/user/4.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/user/5.png")} alt="" /></span>
                              </td>
                              <td><Link to="../#"><span className="list-enq-name">Ethan Oliver</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>+01 8574 6854</td>
                    ...
                    <div className="tab-inn">
                      <div className="table-responsive table-desi">
                        <table className="table table-hover">
                          ...
                          <tbody>
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/course/sm-1.jpg")} alt="" /></span>
                              </td>
                              <td><Link to="../admin-student-details"><span className="list-enq-name">Aerospace Engineering</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>Engineering</td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/course/sm-5.jpg")} alt="" /></span>
                              </td>
                              <td><Link to="../admin-student-details"><span className="list-enq-name">Fashion Technology</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>Fashion</td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/course/sm-2.jpg")} alt="" /></span>
                              </td>
                              <td><Link to="../admin-student-details"><span className="list-enq-name">Agriculture Courses</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>Agriculture</td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/course/sm-3.jpg")} alt="" /></span>
                              </td>
                              <td><Link to="../admin-student-details"><span className="list-enq-name">Marine Engineering</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>Ocean / Marine</td>
                              <td>06 Months</td>
                              <td>12 Feb 2018</td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/course/sm-4.jpg")} alt="" /></span>
                              </td>
                              <td><Link to="../admin-student-details"><span className="list-enq-name">Building, Construction Management</span><span className="list-enq-city">Illunois, United States</span></Link>
                              </td>
                              <td>Construction</td>
                              <td>1 Year</td>
                              <td>05 Mar 2018</td>
                        ...
                        <table className="table table-hover">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>03:00Hrs</td>
                              <td>
                                <Link to="../admin-exam" className="ad-st-view">View</Link>
                              </td>
                            </tr>
                            <tr>
                              <td>
                    ...
                    <div className="tab-inn">
                      <div className="table-responsive table-desi">
                        <table className="table table-hover">
                          ...
                          <tbody>
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/1.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/2.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/3.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/4.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/5.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/6.png")} alt="" /></span>
                              </td>
                            ...
                            <tr>
                              <td><span className="list-img"><img src={require("../asserts/images/sm/7.png")} alt="" /></span>
                              </td>
                  ...
                  <div className="box-inn-sp">
                    ...
                    <div className="tab-inn">
                      <div className="table-responsive table-desi tab-map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6290413.804893654!2d-93.99620524741552!3d39.66116578737809!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880b2d386f6e2619%3A0x7f15825064115956!2sIllinois%2C+USA!5e0!3m2!1sen!2sin!4v1469954001005" title={'Google map'} allowFullScreen />
                      </div>
                    </div>
                  </div>
                </div>
