                            ...
                            <ul>
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/1.png')} alt="" />
                                    </div>
                                ...
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/2.png')} alt="" />
                                    </div>
                                    <div className="ed-ad-dec">
                                        <h4>Research</h4>
                                ...
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/3.png')} alt="" />
                                    </div>
                                    <div className="ed-ad-dec">
                                        <h4>Educations</h4>
                                ...
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/4.png')} alt="" />
                                    </div>
                                    <div className="ed-ad-dec">
                                        <h4>Alumni</h4>
                                ...
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/5.png')} alt="" />
                                    </div>
                                    <div className="ed-ad-dec">
                                        <h4>Facilities</h4>
                                        <p>Maecenas venenatis, turpis ac tincidunt convallis, leo enim ultrices tortor, at faucibus neque sapien ac elit. Curabitur ut ipsum odio.</p>
                                ...
                                <li>
                                    <div className="ed-ad-img">
                                        <img src={require('../asserts/images/adv/6.png')} alt="" />
                                    </div>
                                    <div className="ed-ad-dec">
                                        <h4>Departments</h4>
                                        <p>Maecenas venenatis, turpis ac tincidunt convallis, leo enim ultrices tortor, at faucibus neque sapien ac elit. Curabitur ut ipsum odio.</p>
