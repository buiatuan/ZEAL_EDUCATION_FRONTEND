...
export class Courese_details extends Component{
    render() {
              ...
              <div className="cor">
                ...
                <div className="col-md-6">
                  <div className="cor-mid-img">
                    <img src={require('../asserts/images/course.jpg')} alt="" />
                  </div>
                    ...
                    <div className="cor-p5">
                      ...
                      <ul className="nav nav-tabs">
                        <li className="active"><Link data-toggle="tab" href="#home">
                            <img src={require('../asserts/images/icon/cor4.png')} alt="" /> <span>Requirements</span></Link>
                        </li>
                        <li><Link data-toggle="tab" href="#menu1"><img src={require('../asserts/images/icon/cor3.png')} alt="" /><span>Fees</span></Link></li>
                        <li><Link data-toggle="tab" href="#menu2"><img src={require('../asserts/images/icon/cor1.png')} alt="" /><span>Student Profile</span></Link></li>
                        <li><Link data-toggle="tab" href="#menu2"><img src={require('../asserts/images/icon/cor5.png')} alt="" /><span>How to Apply</span></Link></li>
                      </ul>
                    ...
                    <div className="cor-p6">
                      ...
                      <div className="cor-p6-revi">
                        <div className="cor-p6-revi-left">
                          <img src={require('../asserts/images/4.jpg')} alt="" />
                        </div>
