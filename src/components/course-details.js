              ...
              <div className="cor">
                ...
                <div className="col-md-6">
                  <div className="cor-mid-img">
                    <img src={require('./images/course.jpg')} alt="" />
                  </div>
                    ...
                    <div className="cor-p5">
                      ...
                      <ul className="nav nav-tabs">
                        <li className="active"><Link data-toggle="tab" href="#home">
                            <img src={require('./images/icon/cor4.png')} alt="" /> <span>Requirements</span></Link>
                        </li>
                        <li><Link data-toggle="tab" href="#menu1"><img src={require('./images/icon/cor3.png')} alt="" /><span>Fees</span></Link></li>
                        <li><Link data-toggle="tab" href="#menu2"><img src={require('./images/icon/cor1.png')} alt="" /><span>Student Profile</span></Link></li>
                        <li><Link data-toggle="tab" href="#menu2"><img src={require('./images/icon/cor5.png')} alt="" /><span>How to Apply</span></Link></li>
                      </ul>
