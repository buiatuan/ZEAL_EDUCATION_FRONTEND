              ...
              <div className="ed-mob-menu-con">
                <div className="ed-mm-left">
                  <div className="wed-logo">
                    <a href="index.html"><img src={require('../assets/images/logo.png')} alt="" />
                    </a>
                  </div>
                </div>
                                ...
                                <div className="mm1-com mm1-s1">
                                  <div className="ed-course-in">
                                    <a className="course-overlay menu-about" href="admission.html">
                                      <img src={require('../assets/images/h-about.jpg')} srcset="../assets/images/h_about.jpg" alt="" />
                                      <span>Academics</span>
                                    </a>
                                  </div>
                                </div>
            ...
            <div id="modal1" className="modal fade" role="dialog">
              <div className="log-in-pop">
                ...
                <div className="log-in-pop-right">
                  <a href="#" className="pop-close" data-dismiss="modal"><img src={require('../assets/images/cancel.png')} alt="" />
                  </a>
                  <h4>Login</h4>
                  <p>Don't have an account? Create your account. It's take less then a minutes</p>
                  <form className="s12">
