                  ...
                  <div className="home-top-cour">
                    ...
                    <div className="col-md-9 home-top-cour-desc">
                      ...
                      <div className="hom-list-share">
                        <ul>
                          <li><Link to="../course-details.html"><i className="fa fa-bar-chart" aria-hidden="true" /> Book Now</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-eye" aria-hidden="true" />10 Aavailable</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-share-alt" aria-hidden="true" /> 570</Link> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="home-top-cour">
                    ...
                    <div className="col-md-9 home-top-cour-desc">
                      ...
                      <div className="hom-list-share">
                        <ul>
                          <li><Link to="../course-details.html"><i className="fa fa-bar-chart" aria-hidden="true" /> Book Now</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-eye" aria-hidden="true" />40 Aavailable</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-share-alt" aria-hidden="true" /> 320</Link> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="home-top-cour">
                    ...
                    <div className="col-md-9 home-top-cour-desc">
                      ...
                      <div className="hom-list-share">
                        <ul>
                          <li><Link to="../course-details.html"><i className="fa fa-bar-chart" aria-hidden="true" /> Book Now</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-eye" aria-hidden="true" />04 Aavailable</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-share-alt" aria-hidden="true" /> 1020</Link> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="home-top-cour">
                    ...
                    <div className="col-md-9 home-top-cour-desc">
                      ...
                      <div className="hom-list-share">
                        <ul>
                          <li><Link to="../course-details.html"><i className="fa fa-bar-chart" aria-hidden="true" /> Book Now</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-eye" aria-hidden="true" />32 Aavailable</Link> </li>
                          <li><Link to="../course-details.html"><i className="fa fa-share-alt" aria-hidden="true" /> 124</Link> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
