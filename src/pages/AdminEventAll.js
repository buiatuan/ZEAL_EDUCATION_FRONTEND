                          ...
                          <div className="table-responsive table-desi">
                            <table className="table table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-1.jpg')} alt="" /></span></td>
                                ...
                                <tr>
                                  <td>2</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-2.jpg')} alt="" /></span></td>
                                ...
                                <tr>
                                  <td>3</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-3.jpg')} alt="" /></span></td>
                                ...
                                <tr>
                                  <td>4</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-4.jpg')} alt="" /></span></td>
                                ...
                                <tr>
                                  <td>5</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-5.jpg')} alt="" /></span></td>
                                ...
                                <tr>
                                  <td>6</td>
                                  <td><span className="list-img"><img src={require('./images/course/sm-6.jpg')} alt="" /></span></td>
